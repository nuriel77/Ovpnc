use utf8;
package Ovpnc::Schema::Result::UserRole;
...
Related object: L<Ovpnc::Schema::Result::Role>

=cut

__PACKAGE__->belongs_to(
  "role",
  "Ovpnc::Schema::Result::Role",
  { id => "role_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IwPmCK5Rid4aOfZDq89rog
