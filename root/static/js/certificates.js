        ...
        setCertificatesTable: function() {
            ...
            $('#flexme').flexigrid({            
                ...
                // TODO: Save table proportions in cookie
                    ...
                    { display: 'Province',  name : 'key_province',  width : 120, sortable : true, align: 'left' },
                    { display: 'City',      name : 'key_city',      width : 120, sortable : true, align: 'left' },
                    { display: 'Org',       name : 'key_org',       width: 90, sortable : true, align: 'left' },
                    { display: 'Org Unit',  name : 'key_ou',        width: 90, sortable : true, align: 'left' },
                    ...
                    { display: 'Key File',  name : 'key_file',      width: 400, sortable : true, align: 'left' },
                    { display: 'Cert File', name : 'cert_file',     width: 400, sortable : true, align: 'left' },
